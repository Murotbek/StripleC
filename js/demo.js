(function() {
    ...
    var imageOptions = {
        angle: 45,
        extraSpacing: {extraX: 200, extraY: 200},
    ...
    var numberOptions = {
        color: 'white',
        backgroundColor: 'rgba(255, 200, 135, 0.2)',
        fontSize: function() { return windowWidth > 1536 ? 50 : 20; },
        fontSize: function() { return windowWidth > 720 ? 30 : 10; },
        padding: function() { return windowWidth > 1536 ? '18 35 10 38' : '18 25 10 28'; },
        padding: function() { return windowWidth > 720 ? '10 20 10 20' : '18 25 10 28'; },
        angle: 0,
        piecesSpacing: 2,
        ...
        ty: function() { return Pieces.random(-200, 200); },
        translate: function() {
            if (windowWidth > 1920) return {translateX: 190, translateY: -305};
            if (windowWidth > 1535) return {translateX: 140, translateY: -240};
            if (windowWidth > 1023) return {translateX: 110, translateY: -190};
